...
contract ERC_Token_8 {
    ...
    string public token_name = "Gravity";
    string public token_symbol = "GRV";
    ...
    function mint_token (uint _amount) public Only_Owner returns (bool) {
        require(_amount > 0 , "Increase amount!");
    ...
    function burn_token (uint _amount) public Only_Owner Check_Balance (OWNER , _amount) returns(bool) {
        require(_amount > 0 , "Increase amount!");
